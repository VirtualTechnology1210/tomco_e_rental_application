...
export const ownerSignupSchema = signupSchema.shape({
...
export const createVehicleSchema = yup.object({
    ...
    year: yup.number().min(1990).max(new Date().getFullYear() + 1).nullable().optional(),
...
export const reviewSchema = yup.object({
    ...
    comment: yup.string().max(1000).nullable().optional(),
});
...
export type OwnerSignupFormData = yup.InferType<typeof ownerSignupSchema>;
export type CreateVehicleFormData = yup.InferType<typeof createVehicleSchema>;
export type ReviewFormData = yup.InferType<typeof reviewSchema>;
export type OwnerProfileFormData = yup.InferType<typeof ownerProfileSchema>;
