...
const AppInput = ({
  ...
  return <View style={[styles.container, containerStyle]}>
            ...
            <View style={[styles.inputContainer, { borderColor }, disabled && styles.disabled]}>
                {leftIcon && <Icon name={leftIcon} size={20} color={Colors.textMuted} style={styles.leftIcon} />}
                <TextInput
    style={[
      styles.input,
  ...
  />
                {secureTextEntry && <TouchableOpacity onPress={() => setIsSecureVisible(!isSecureVisible)} style={styles.rightIcon}>
                        <Icon name={isSecureVisible ? "eye-off" : "eye"} size={20} color={Colors.textMuted} />
                    </TouchableOpacity>}
                {rightIcon && !secureTextEntry && <TouchableOpacity onPress={onRightIconPress} style={styles.rightIcon}>
...
var AppInput_default = AppInput;
export {
  AppInput_default as default
};
