...
const StatusChip = ({ status, size = "md", style }) => {
  ...
  return <View style={[styles.chip, { backgroundColor: colorSet.bg, paddingHorizontal: paddingH, paddingVertical: paddingV }, style]}>
...
var StatusChip_default = StatusChip;
export {
  StatusChip_default as default
};
