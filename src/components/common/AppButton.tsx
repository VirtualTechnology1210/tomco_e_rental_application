...
const AppButton: React.FC<AppButtonProps> = ({
    ...
    disabled = false, fullWidth = true, icon, iconRight, style, textStyle,
}) => {
    ...
    const getColors = (): { bg: string; text: string; border?: string; gradientColors?: string[] } => {
        switch (variant) {
            case 'primary': return { bg: Colors.primary, text: Colors.white, gradientColors: [Colors.primary, Colors.primaryDark] };
            case 'secondary': return { bg: Colors.secondary, text: Colors.white, gradientColors: [Colors.secondary, Colors.secondaryDark] };
            ...
            case 'ghost': return { bg: Colors.transparent, text: Colors.primary };
