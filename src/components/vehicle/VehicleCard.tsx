...
const VehicleCard: React.FC<VehicleCardProps> = ({ vehicle, onPress, variant = 'user', onToggleAvailability }) => {
    ...
    return (
        <TouchableOpacity style={[styles.card, Shadows.card]} onPress={onPress} activeOpacity={0.85}>
            <View style={styles.imageContainer}>
                ...
                {variant === 'user' && vehicle.distance_km !== undefined && (
            ...
            <View style={styles.content}>
                ...
                <View style={styles.bottomRow}>
                    ...
                    {variant === 'user' && vehicle.avg_rating && (
                        <View style={styles.ratingRow}>
                            <Icon name="star" size={14} color={Colors.rating} />
                            <Text style={styles.rating}>{vehicle.avg_rating}</Text>
                            {vehicle.total_reviews !== undefined && (
                                <Text style={styles.reviewCount}>({vehicle.total_reviews})</Text>
                            )}
                        </View>
                    )}
                </View>
