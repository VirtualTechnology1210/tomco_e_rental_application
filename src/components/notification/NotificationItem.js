...
const NotificationItemCard = ({ notification, onPress }) => {
  ...
  >
            ...
            <View style={styles.content}>
                ...
                {notification.body && <Text style={styles.body} numberOfLines={2}>{notification.body}</Text>}
...
var NotificationItem_default = NotificationItemCard;
export {
  NotificationItem_default as default
};
