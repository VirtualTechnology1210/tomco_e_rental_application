...
const ProfileScreen = ({ navigation }) => {
  ...
  const menuItems = [
    ...
    { icon: "file-document-outline", label: "Terms of Service", onPress: () => {
    }, color: Colors.textSecondary },
  ...
  return <View style={styles.container}>
    ...
    /* Profile Header */
                ...
                <View style={styles.profileSection}>
                    <View style={styles.avatarContainer}>
                        {profile?.profile_image ? <View style={styles.avatar}><Icon name="account" size={40} color={Colors.textMuted} /></View> : <View style={styles.avatar}><Icon name="account" size={40} color={Colors.textMuted} /></View>}
                    </View>
    ...
    /* Menu */
                ...
                <View style={[styles.menuCard, Shadows.card]}>
                    {menuItems.map((item, index) => <TouchableOpacity key={item.label} style={[styles.menuItem, index < menuItems.length - 1 && styles.menuBorder]} onPress={item.onPress}>
...
export {
  ProfileScreen_default as default
};
