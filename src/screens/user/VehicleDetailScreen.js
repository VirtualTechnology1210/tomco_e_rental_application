  ...
  return <View style={styles.container}>
    ...
    /* Hero Image Gallery */
                ...
                <View style={styles.heroContainer}>
                    {images.length > 0 ? <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false}>
                            {images.map((img) => <Image key={img.id} source={{ uri: img.image_url }} style={styles.heroImage} resizeMode="cover" />)}
                        </ScrollView> : <View style={styles.heroPlaceholder}>
    ...
    /* Title Row */
                    ...
                    <View style={styles.titleRow}>
                        ...
                        {vehicle.avg_rating && <View style={styles.ratingBox}>
    ...
    /* Location */
                    ...
                    {vehicle.location_name && <View style={styles.locationRow}>
    ...
    /* Owner */
                    ...
                    {vehicle.owner && <View style={[styles.card, Shadows.card]}>
    ...
    /* Reviews */
                    ...
                    {reviews.length > 0 && <View style={styles.reviewsSection}>
                            ...
                            {reviews.slice(0, 5).map((review) => <View key={review.id} style={styles.reviewItem}>
                                    <View style={styles.reviewHeader}>
                                        <Text style={styles.reviewerName}>{review.reviewer?.full_name}</Text>
                                        <View style={styles.starsRow}>
                                            {Array.from({ length: 5 }).map((_, i) => <Icon key={i} name={i < review.rating ? "star" : "star-outline"} size={14} color={Colors.rating} />)}
                                        </View>
                                    </View>
    ...
    /* Sticky Bottom Bar */
            ...
            {vehicle.availability && vehicle.status === "ACTIVE" && <View style={[styles.bottomBar, Shadows.bottomTab]}>
                    <View>
...
var VehicleDetailScreen_default = VehicleDetailScreen;
export {
  VehicleDetailScreen_default as default
};
