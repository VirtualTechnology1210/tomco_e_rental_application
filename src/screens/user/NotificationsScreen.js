...
const NotificationsScreen = ({ navigation }) => {
  ...
  const renderItem = useCallback(({ item }) => <NotificationItemCard notification={item} onPress={() => {
  }} />, []);
  return <View style={styles.container}>
            ...
            {isLoading ? <AppLoader /> : notifications.length === 0 ? <AppEmpty icon="bell-off-outline" title="No notifications" subtitle="You're all caught up!" /> : <FlatList
    data={notifications}
...
var NotificationsScreen_default = NotificationsScreen;
export {
  NotificationsScreen_default as default
};
