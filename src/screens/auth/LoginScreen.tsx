...
const LoginScreen: React.FC<AuthScreenProps<'Login'>> = ({ navigation, route }) => {
    ...
    const loginMutation = useMutation({
        mutationFn: (data: LoginFormData) => authApi.login({ phone: `${COUNTRY_CODE}${data.phone}`, password: data.password }),
