...
const ForgotPasswordScreen = ({ navigation }) => {
  ...
  const mutation = useMutation({
    mutationFn: (data) => authApi.forgotPassword({ phone: `${COUNTRY_CODE}${data.phone}` }),
...
var ForgotPasswordScreen_default = ForgotPasswordScreen;
export {
  ForgotPasswordScreen_default as default
};
