...
import { OwnerDashboardStackParams } from '../../types/navigation.types';

type Props = NativeStackScreenProps<OwnerDashboardStackParams, 'OwnerDashboard'>;
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView refreshControl={<RefreshControl refreshing={isRefetching} onRefresh={refetch} tintColor={Colors.ownerAccent} />} contentContainerStyle={styles.scroll}>
                ...
                {user?.status === 'PENDING' && (
                    <View style={styles.pendingBanner}><Icon name="clock-outline" size={18} color={Colors.warning} /><Text style={styles.pendingText}>Verification Pending</Text></View>
                )}
                    ...
                    <View style={styles.section}>
                        ...
                        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                            ...
                            {vehicles.slice(0, 3).map((v) => (
                                <View key={v.id} style={styles.vehicleHScroll}>
