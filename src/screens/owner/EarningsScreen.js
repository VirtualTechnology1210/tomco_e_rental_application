...
const EarningsScreen = ({ navigation }) => {
  ...
  return <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scroll}>
                ...
                {(earnings?.monthly_breakdown || []).map((m, i) => <View key={i} style={[styles.monthRow, Shadows.card]}>
                        <View>
...
var EarningsScreen_default = EarningsScreen;
export {
  EarningsScreen_default as default
};
