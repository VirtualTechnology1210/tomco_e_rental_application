...
import { UserTabParams, UserHomeStackParams, UserSearchStackParams, UserBookingStackParams, UserProfileStackParams } from '../types/navigation.types';
...
// Stacks
const HomeStack = createNativeStackNavigator<UserHomeStackParams>();
const SearchStack = createNativeStackNavigator<UserSearchStackParams>();
const BookingStack = createNativeStackNavigator<UserBookingStackParams>();
const ProfileStack = createNativeStackNavigator<UserProfileStackParams>();
...
const UserTabNavigator = () => {
    ...
    return (
        ...
        >
            ...
            <Tab.Screen name="Bookings" component={BookingStackScreen} options={{ tabBarBadge: unreadCount > 0 ? unreadCount : undefined }} />
